  ...
  return (
    <section className="control-sheet" aria-label="송출 제어">
      ...
      <div className="fields">
        <TextField
          disabled={props.status === "live"}
          label="스트림 ID"
          name="streamId"
          onChange={(event) => props.onStreamIdChange(event.target.value)}
          value={props.streamId}
        />
      </div>
      <p
        className={props.status === "error" || props.sensorError
